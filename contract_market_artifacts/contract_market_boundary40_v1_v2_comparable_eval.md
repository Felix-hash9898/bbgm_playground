# boundary40 v1/v2 Comparable Evaluation
...
| ----- | ------- | ------------- | --------------- | -------- | ---------- | ------- | ------- | ------- | ------------ | -------------- | --------- | ------- | -------- | ------ | --------------- |
| v1    | 28      | 6/28 (21.4%)  | 8/28 (28.6%)    | 3.44     | 2.69       | 4.46    | 7.19    | 16.08   | 5.16         | 2.79           | -4.63     | 21      | 1        | 3      | 3               |
| v2    | 28      | 7/28 (25.0%)  | 15/28 (53.6%)   | 2.48     | 0.73       | 2.47    | 7.05    | 14.27   | 4.23         | 2.71           | -3.33     | 20      | 1        | 3      | 3               |

## Winner Summary

| metric                            | value |
| --------------------------------- | ----- |
| v2 better by point gap            | 16    |
| v1 better by point gap            | 3     |
| tie by point gap                  | 9     |
| v2 better by midpoint error       | 18    |
| v1 better by midpoint error       | 5     |
| tie by midpoint error             | 5     |
| mean delta point gap M            | -0.96 |
| median delta point gap M          | -0.35 |
| mean delta abs midpoint error M   | -0.93 |
| median delta abs midpoint error M | -0.81 |
...
| boundary40 | E-03 | B40-19 | Malik Beasley            | high_end_rotation_sixth_man | $6.00M-$10.00M  | $3.37M-$3.88M   | 3.63     | 3.63     | 2.38   | 2.37   | 0         | 4.38       | 4.37       | tie        |                                                       | none       |
...
| boundary40 | H-01 | B40-29 | Kevin Knox               | good_high_starter           | $25.00M-$35.00M | $26.29M-$34.80M | 30.54    | 33.02    | 0      | 0      | 0         | 0.54       | 3.02       | tie        | high_turnover_role_player_risk                              | low        |
| boundary40 | E-03 | B40-19 | Malik Beasley            | high_end_rotation_sixth_man | $6.00M-$10.00M  | $3.37M-$3.88M   | 3.63     | 3.63     | 2.38   | 2.37   | 0         | 4.38       | 4.37       | tie        |                                                             | none       |
| boundary40 | E-01 | B40-17 | Yogi Ferrell             | high_end_rotation_sixth_man | $8.00M-$12.00M  | $6.19M-$9.28M   | 7.73     | 7.77     | 0.27   | 0.23   | -0.04     | 2.27       | 2.23       | tie        | small_guard_defense_stat_risk; non_scoring_impact_positive  | none       |
| boundary40 | G-04 | B40-28 | Džanan Musa              | solid_starter               | $12.00M-$18.00M | $3.15M-$3.62M   | 3.38     | 3.44     | 8.62   | 8.56   | -0.05     | 11.62      | 11.56      | tie        | high_turnover_creator_risk                                  | medium     |
...
| mean v1 intervalScore lambda .10 | 2.19  |
| mean v1 intervalScore lambda .15 | 2.48  |
| mean v1 intervalScore lambda .20 | 2.77  |
| mean v2 point gap                | 2.48  |

## Conclusion

| metric             | conclusion         | detail                           |
| ------------------ | ------------------ | -------------------------------- |
| point-to-range gap | v2 improves        | v1 mean 3.44M vs v2 mean 2.48M   |
| midpoint error     | v2 improves        | v1 mean 5.16M vs v2 mean 4.23M   |
| bias               | v2 less biased     | v1 bias -4.63M vs v2 bias -3.33M |
| severe count       | tie                | v1 severe 3 vs v2 severe 3       |
| winner count       | v2 wins more cases | v2 16, v1 3, tie 9               |
